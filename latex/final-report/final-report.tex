...
\begin{tabular}{lllll}
	...
	& \multicolumn{2}{l}{Train MSE} & \multicolumn{2}{l}{Test MSE} \\ 
	& \multicolumn{2}{l}{mse} & \multicolumn{2}{l}{mse} \\ 
	model name  & mean & sd & mean & \multicolumn{1}{l}{sd} \\ 
	\hline
...
\begin{landscape}
	\centering
	\captionof{table}{Test}\label{tab:train-mse-1000-10}
