...
Because we ran simulations using 270 different combinations of factors, we will just highlight results that are indicative of overall trends or that show interesting results. However, the full tables of results can be found in Appendix \ref{app:full-results}.

Recall that we considered three possible values of $n$ (50, 200, and 1000) and three values of $p$ (10, 100, 2000). We will first consider the extreme case when $n = 1000$ and $p = 10$. Figures \ref{fig:train-mse-1000-10} and \ref{fig:test-mse-1000-10} show the average mean squared error for each model for the training set and test set, respectively. Different rows of the figure represent different values of $\sigma$, the strength of the random error. Columns represent the type of correlation (such as independent or symmetric compound). The different types of points represent the strength of the correlation. Hence, each point represents the average mean squared error for one specific combination of factors across 100 iterations. Tables \ref{tab:train-mse-1000-10} and \ref{tab:test-mse-1000-10} in Appendix \ref{app:full-results} contain all of the values in these figures, as well as the standard deviation for each point.

\begin{figure}[h!]
	\centering
	\includegraphics[width = \textwidth]{images/facet-train-mse/facet_train_mse_1000_10.png}
	\caption{Average mean squared error for all simulated models when $n = 1000$ and $p = 10$.}
	\label{fig:train-mse-1000-10}
	
	\bigskip
	
	\includegraphics[width = \textwidth]{images/facet-test-mse/facet_test_mse_1000_10.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width = \textwidth]{images/facet-train-mse/facet_train_mse_50_2000.png}
	\caption{Average Mean Square Error for Empirical Data Models}
	\label{fig:train-mse-50-2000}
	
	\bigskip
	
	\includegraphics[width = \textwidth]{images/facet-test-mse/facet_test_mse_50_2000.png}
	\caption{Average Mean Square Error for Empirical Data Models}
