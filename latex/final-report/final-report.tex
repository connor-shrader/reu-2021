...
\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.9\linewidth]{images/facet-train-mse/facet_train_mse_1000_10.png}
	\label{fig:train-mse-1000-10}
	\caption{Average Mean Square Error for Empirical Data Models}
\end{figure}

See table \ref{tab:train-mse-1000-10}

\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.9\linewidth]{images/facet-test-mse/facet_test_mse_1000_10.png}
	\label{fig:test-mse-1000-10}
	\caption{Average Mean Square Error for Empirical Data Models}
\end{figure}

See table \ref{tab:test-mse-1000-10}

\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.9\linewidth]{images/facet-train-mse/facet_train_mse_50_2000.png}
	\label{fig:train-mse-50-2000}
	\caption{Average Mean Square Error for Empirical Data Models}
\end{figure}

See table \ref{tab:train-mse-50-2000}

\begin{figure}[h!]
	\centering
	\includegraphics[width = 0.9\linewidth]{images/facet-test-mse/facet_test_mse_50_2000.png}
	\label{fig:test-mse-50-2000}
	\caption{Average Mean Square Error for Empirical Data Models}
\end{figure}

See table \ref{tab:test-mse-50-2000}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Discussion}
