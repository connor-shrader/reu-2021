...
\begin{landscape}
	...
	\captionof{table}{Mean and standard deviation of the mean squared error on training data when $n = 1000$ and $p = 10$. See Figure \ref{fig:train-mse-50-2000} for the corresponding plot.}
	\label{tab:train-mse-1000-10}
	\input{./tables/train_mse_1000_10.tex}
	
	\newpage
	
	\captionof{table}{Mean and standard deviation of the mean squared error on test data when $n = 1000$ and $p = 10$. See Figure \ref{fig:test-mse-50-2000} for the corresponding plot.}
	\label{tab:test-mse-1000-10}
	\input{./tables/test_mse_1000_10.tex}
	
	\newpage
	\captionof{table}{Mean and standard deviation of the $\beta$-sensitivity when $n = 1000$ and $p = 10$. See Figure \ref{fig:sensitivity-1000-10} for the corresponding plot.}
	\label{tab:sensitivity-1000-10}
	\input{./tables/sensitivity_1000_10.tex}
	
	\newpage
	
	\captionof{table}{Mean and standard deviation of the $\beta$-specificity when $n = 1000$ and $p = 10$. See Figure \ref{fig:specificity-1000-10} for the corresponding plot.}
	\label{tab:specificity-1000-10}
	\input{./tables/specificity_1000_10.tex}
	
	\newpage
	
	\captionof{table}{Mean and standard deviation of the mean squared error on training data when $n = 50$ and $p = 2000$. See Figure \ref{fig:train-mse-50-2000} for the corresponding plot.}
	\label{tab:train-mse-50-2000}
	\input{./tables/train_mse_50_2000.tex}
	
	\newpage
	
	\captionof{table}{Mean and standard deviation of the mean squared error on training data when $n = 50$ and $p = 2000$. See Figure \ref{fig:test-mse-50-2000} for the corresponding plot.}
	\label{tab:test-mse-50-2000}
	\input{./tables/test_mse_50_2000.tex}
	
	\newpage
	
	\captionof{table}{Mean and standard deviation of the $\beta$-sensitivity when $n = 50$ and $p = 2000$. See Figure \ref{fig:sensitivity-50-2000} for the corresponding plot.}
	\label{tab:sensitivity-50-2000}
