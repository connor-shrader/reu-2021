...
\begin{figure}[h!]
	...
	\caption{Average False Negatives for Monte Carlo Models}
...
\begin{table}
\centering
\caption{Cross Validation Results on Empirical Data}
...
\begin{tabular}{lllll}
	...
	Elastic Net  & $0.1799$ & $0.0127$ & $0.2281$ & $0.0469$ \\
	SCAD  & $0.1442$ & $0.0333$ & $0.2218$ & $0.0303$ \\
	MCP  & $0.1566$ & $0.0129$ & $0.2202$ & $0.0224$ \\
	XGBoost  & $0.0002$ & $0.0004$ & $0.2233$ & $0.0507$ \\
	Random Forest  & $0.0378$ & $0.0013$ & $0.2653$ & $0.0525$ \\
	\hline 
\end{tabular}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|}
		\hline
		Model         & Average Runtime (s) \\ \hline
		Ridge         & 29.29               \\ \hline
		Lasso         & 9.57                \\ \hline
		Elastic Net   & 9.41                \\ \hline
		SCAD          & 17.28               \\ \hline
		MCP           & 15.15               \\ \hline
		XGBoost       & 538.12              \\ \hline
		Random Forest & 4906.59             \\ \hline
	\end{tabular}
\end{table}
