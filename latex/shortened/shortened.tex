...
\author{Gabriel Ackall$^{1\dagger}$, Connor Shrader$^{2\dagger}$, Seongtae Kim$^3$* \\
	...
	{\footnotesize *Correspondence: skim@ncat.edu} \\
	{\footnotesize $^\dagger$Authors Contributed Equally}}
\date{\today}
