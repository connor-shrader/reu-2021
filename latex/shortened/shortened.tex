...
\begin{document}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 0.7\textwidth]{images/linear-facet/sensitivity/facet_sensitivity_1_50_2000.eps}
		\captionsetup{width = 0.8\textwidth}
		...
		\includegraphics[width = 0.7\textwidth]{images/linear-facet/specificity/facet_specificity_1_50_2000.eps}
		\captionsetup{width = 0.8\textwidth}
