\documentclass[final,onefignum,onetabnum]{siuro210301}
\usepackage[utf8]{inputenc}

%%%%%%
% Copied from siuro_article.tex example
...
% Sets running headers
\headers{A Comparative Study of Penalized Regression and Machine Learning Algorithms}{G. Ackall and C. Shrader}
...
\dedication{\small\textit{Project advisor: Seongtae Kim\thanks{North Carolina A\&T State University, Mathematics and Statistics, Greensboro, NC}}}
...
\ifpdf
\hypersetup{
	pdftitle={A Comparative Study of Penalized Regression and Machine Learning Algorithms in High Dimensional Scenarios},
	pdfauthor={G. Ackall and C. Shrader}
}
\fi
