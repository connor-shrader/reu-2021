...
Our simulation study considered two different functions for the response variable $Y$. First, we assumed that the relationship between the response variable $Y$ and the predictors $X_1, X_2, \dotsc, X_p$ was linear. That is, we assumed that
\begin{equation}
...
Our second response function was not entirely linear. Instead, we calculated $\mathbf{y}$ as
...
\begin{figure}[h!]
	...
	\label{fig:linear-linear-train-mse-50-2000}
	...
	\label{fig:linear-linear-test-mse-50-2000}
\end{figure}
...
\begin{figure}[h!]
	...
	\label{fig:linear-linear-sensitivity-50-2000}
	...
	\label{fig:linear-linear-specificity-50-2000}
\end{figure}
...
\begin{figure}[h!]
	...
	\includegraphics[width = \textwidth]{images/nonlinear-facet/train-mse/facet_train_mse_2_50_2000.eps}
	\captionsetup{width = 0.8\textwidth}
	\caption{Average mean square error using training data for nonlinear simulations when $n = 50$ and $p = 2000$.}
