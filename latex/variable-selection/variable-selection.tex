...
\[X = \begin{bmatrix}
	\mathcal{N}(0,\,1)_{1\,1} & \mathcal{N}(0,\,1)_{1\,2} & \dots & \mathcal{N}(0,\,1)_{1\,p}\\
	\mathcal{N}(0,\,1)_{2\,1} & \mathcal{N}(0,\,1)_{2\,2} & &\\
	\vdots & & \ddots &\\
	\mathcal{N}(0,\,1)_{n\,1} & & & \mathcal{N}(0,\,1)_{n\,p}
\end{bmatrix} .\]
...
\begin{equation}
	bias \text{(model)} = \sqrt{\sum_{i=1}^{p}\left( \beta_i - \hat{\beta}_i \right)^2} \, .
\end{equation}
