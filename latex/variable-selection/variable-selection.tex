...
\[M = \begin{bmatrix}
	...
	\beta_p
\end{bmatrix} \]
with the true coefficient values $\beta_0$ through $\beta_p$ that will later be compared to the fitted coefficient values.

Secondly, a $n$ x $p$ matrix $X$ is generated such that

\[X = \begin{bmatrix}
	\mathcal{N}(\mu,\,\sigma^{2})_{1,1} & \mathcal{N}(\mu,\,\sigma^{2})_{1,2} & \dots & \mathcal{N}(\mu,\,\sigma^{2})_{1,p}\\
	\mathcal{N}(\mu,\,\sigma^{2})_{2,1} & \mathcal{N}(\mu,\,\sigma^{2})_{2,2} & &\\
	\vdots & & \ddots &\\
	\mathcal{N}(\mu,\,\sigma^{2})_{n,1} & & & \mathcal{N}(\mu,\,\sigma^{2})_{n,p}
\end{bmatrix} .\]
...
\[E = \begin{bmatrix}
	\mathcal{N}(\mu,\,\sigma^{2})_1 \\
 	\mathcal{N}(\mu,\,\sigma^{2})_2 \\
  	\vdots \\
   	\mathcal{N}(\mu,\,\sigma^{2})_n
\end{bmatrix} .\]
