...
\subsubsection{Choice of the Covariance Matrix}
...
Blocks denoted as $O$ are zero blocks. Each block $S_i$ has the form
\begin{equation}
	\mathbf{\Sigma} = \begin{bmatrix}
...
\begin{equation}
	\mathbf{\Sigma} = \begin{bmatrix}
		\sigma_1^2 & \sigma_{12} & \cdots 7 \sigma_{1p}\\
...
\subsection{Autoregressive Covariance}
