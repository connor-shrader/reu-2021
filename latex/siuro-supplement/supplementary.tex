\documentclass[final,supplement,onefignum,onetabnum]{siuro210301}
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[EC]{G. Ackall and C. Shrader}
\fancyhead[OC]{Supplementary Materials: A Comparative Study of Penalized Regression and Machine Learning Algorithms in High Dimensional Scenarios}
\fancyhead[L]{}
\fancyhead[R]{}
\fancyfoot[C]{\thepage}
...
\newcommand{\facetfigureinner}[7]{
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=0.8\textwidth]{figures/#6-facet/#4/facet\_#3\_#6\_#1\_#2.eps}
